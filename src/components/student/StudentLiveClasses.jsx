                        ...
                        <div key={room.id} className="group bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 relative">
                            ...
                            <div className="pt-8 p-6">
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#0a0a0a] hover:bg-black dark:bg-white dark:hover:bg-gray-200 text-white dark:text-[#0a0a0a] font-medium py-3 rounded-xl transition-all transform active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-black/25"
                                >
                                    <Video size={20} />
