            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-8">
                ...
                <form onSubmit={createRoom} className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <button
                        ...
                        className="bg-[#0a0a0a]hover:bg-black dark:hover:bg-gray-200 dark:bg-white dark:text-[#0a0a0a]text-white px-6 py-2 rounded-xl font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors h-[42px]"
                    >
                        <Plus size={20} />
                        Criar
                    </button>
                        ...
                        <div key={room.id} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <button
                                    ...
                                    className="px-4 py-1.5 text-sm font-medium text-white dark:text-[#0a0a0a]bg-[#0a0a0a] dark:bg-whitehover:bg-black dark:hover:bg-gray-200 rounded-lg flex items-center gap-2 shadow-sm shadow-indigo-200 dark:shadow-none"
                                >
