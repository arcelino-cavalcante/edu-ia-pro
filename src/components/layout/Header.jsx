    ...
    return (
        <header className="h-20 border-b border-gray-100 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl sticky top-0 z-30 px-4 md:px-8 flex items-center justify-between transition-colors">
            ...
            <div className="flex-1 max-w-xl relative hidden md:block">
                ...
                <input
                    type="text"
                    placeholder="Busque por cursos, aulas ou trilhas..."
                    className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl py-3 pl-12 pr-4 text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all font-medium"
                />
            </div>
